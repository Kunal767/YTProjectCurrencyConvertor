...
root.title("Kunal Currency Convertor")
...
Title = Label(root, text="Kunal Currency Convertor", fg="green",  bg="lightblue", font=("ubuntu", 15, "italic"))
...
footer = Label(root, text="Developed and Designed By Kunal Gupta",bg="lightblue", fg="grey", font=("ubuntu", 15, "bold"))
